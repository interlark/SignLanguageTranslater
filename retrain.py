...
By default, this script will log summaries to os.path.join(os.path.sep, tempfile.gettempdir(),'retrain_logs') directory

Visualize the summaries with this command:

tensorboard --logdir os.path.join(os.path.sep, tempfile.gettempdir(),'retrain_logs')
...
python retrain.py (... other args as before ...) \
    --saved_model_dir=os.path.join(os.path.sep, tempfile.gettempdir(),'saved_models',os.path.sep,$(date +%s),os.path.sep)
tensorflow_model_server --port=9000 --model_name=my_image_classifier \
    --model_base_path=os.path.join(os.path.sep, tempfile.gettempdir(),'saved_models')
```
"""
...
CHECKPOINT_NAME = os.path.join(os.path.sep, tempfile.gettempdir(),'_retrain_checkpoint')
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
	  default=os.path.join(os.path.sep, tempfile.gettempdir(),'output_labels.txt'),
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default=os.path.join(os.path.sep, tempfile.gettempdir(),'bottleneck'),
